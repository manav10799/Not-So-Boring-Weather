...
export const weatherMessages = {
  ...
  Clouds: [
    ...
    "fucking gray blanket",
    "cloud cover, no fucks",
    "sky’s dull as shit",
    "overcast like a boss",
  ],
  Rain: [
    ...
    "fuck, water everywhere",
    "rain’s pissing hard",
    "better drown today",
    "fuckin’ fresh wet socks",
  ],
  Snow: [
  ...
  Sand: [
    ...
    "fuckin’ sandy hell",
    "grit in eyes",
    "fuck sand everywhere",
    "sandstorms suck balls",
  ],
  Ash: [
